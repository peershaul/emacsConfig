...
(use-package general
  ...
  (rune/leader-keys)
    ...
    "b"  '(nuke-all-buffers :which-key "kill all buffers")))
...
;; Some usefull functionallity
;; recursive search: counsel-projectile-rg
;; configure local variables for current project, like compiling or running in C-c p E
(use-package projectile
  ...
  :init
  (when (file-directory-p "~/smallmass/dev")
    (setq projectile-project-search-path '("~/smallmass/dev")))
...
(add-to-list 'load-path "/usr/share/sdcc/include/msc51")
